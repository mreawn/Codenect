...
<html lang="en">
  ...
  $('#submit').submit(function(e){
      e.preventDefault();
       $.ajax({
           url:base_url + "index.php/teacher/update_image",
           type:"post",
  ...
  function edit_profile() {
    ...
    $('.modal-profile').append('<div class="form-inline">'+
                                  ...
                                  '<input type="text" class="form-control" id="school" value="<?php echo $school  ?>">'+
                                  '</div>'+
                                  '<div class="form-group">' +
  ...
  function update_profile() {
    ...
    $.ajax({
        ...
        method: 'POST',
        data: { fname:$fname ,mname:$mname ,lname:$lname ,age:$age, gender:$gender ,school:$school ,email:$email, bday:$bday },
